...
local s = {
    ...
    Minlord = {Width = 500, Height = 300},
    Maxlord = {Width = 1200, Height = 800},
...
function Library.new(title, configFolder)
    ...
    self._minSize = Vector2.new(s.Minlord.Width, s.Minlord.Height)
    self._maxSize = Vector2.new(s.Maxlord.Width, s.Maxlord.Height)
...
function Library:_CreateMainlord()
    ...
    local titleClickBtn = CreateInstance("TextButton", {
        Name = "TitleClickBtn",
        Text = "",
        BackgroundTransparency = 1,
        Size = UDim2.new(1, 0, 1, 0),
    ...
    titleClickBtn.MouseButton1Click:Connect(function()
        self:_ToggleMinimize()
    end)

    titleClickBtn.MouseEnter:Connect(function()
        CreateTween(self.titleLabel, {TextColor3 = c.TextDark}, animationspeed.Fast)
    end)

    titleClickBtn.MouseLeave:Connect(function()
        CreateTween(self.titleLabel, {TextColor3 = c.Text}, animationspeed.Fast)
    end)
